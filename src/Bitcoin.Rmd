...
model_010_ml = arima(Bitcoin.boxcox, order=c(0,1,0),method='ML')
coeftest(model_010_ml)

# ARIMA(0,2,2)
model_022_css = arima(Bitcoin.boxcox,order=c(0,1,2),method='CSS')
coeftest(model_022_css)

model_022_ml = arima(Bitcoin.boxcox,order=c(0,1,2),method='ML')
coeftest(model_022_ml)

# ARIMA(0,2,3)
model_023_css = arima(Bitcoin.boxcox,order=c(0,1,3),method='CSS')
coeftest(model_023_css)

model_023_ml = arima(Bitcoin.boxcox,order=c(0,1,3),method='ML')
coeftest(model_023_ml)

# ARIMA(0,2,4)
model_024_css = arima(Bitcoin.boxcox,order=c(0,2,4),method='CSS')
coeftest(model_024_css)

model_024_ml = arima(Bitcoin.boxcox,order=c(0,2,4),method='ML')
coeftest(model_024_ml)

# ARIMA(1,2,2)
model_122_css = arima(Bitcoin.boxcox,order=c(1,2,2),method='CSS')
coeftest(model_122_css)

model_122_ml = arima(Bitcoin.boxcox,order=c(1,2,2),method='ML')
coeftest(model_122_ml)

# ARIMA(1,2,3)
model_123_css = arima(Bitcoin.boxcox,order=c(1,2,3),method='CSS')
coeftest(model_123_css)

model_123_ml = arima(Bitcoin.boxcox,order=c(1,2,3),method='ML')
